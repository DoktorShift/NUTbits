...
Also, the bankify *software* does not validate responses given by a mint. So a mint can track you by giving you an invalid proof and then waiting for you to spend it. I am grateful if someone modifies bankify so that it *does* validate data! Pull requests welcome.
