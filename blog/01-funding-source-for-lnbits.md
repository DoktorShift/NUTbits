...
If you're already in the ecash world, whether running a mint, using one, or experimenting with Cashu, this is where things get interesting. NUTbits bridges your mint to LNBits through Nostr Wallet Connect, and suddenly your ecash can power an entire Lightning platform.
...
Everything just works. Every extension, every wallet, every feature LNBits offers, all powered by ecash from your mint. Your users interact with Lightning the way they always do. The ecash layer is invisible to them but meaningful to you.
